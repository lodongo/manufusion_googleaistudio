...
const FlUserPage: React.FC<ModulePageProps> = ({ module, currentUser, onSwitchToAdmin, onBackToDashboard, theme }) => {
    ...
    <div className="p-4 md:p-8 w-full">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600">
          This is the dedicated user page for the Fleet (FL) module.
          Future functionality for vehicle tracking, maintenance logs, and trip reports will be displayed here.
        </p>
      </div>
    </div>
  );
