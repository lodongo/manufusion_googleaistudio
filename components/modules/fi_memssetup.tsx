...
import JournalClassModal from './fi/JournalClassModal';
import CurrenciesTab from './fi/CurrenciesTab';
...
const FiMemsSetupPage: React.FC<ModuleSetupPageProps> = ({ module, onBackToModules }) => {
  ...
  const renderTabContent = () => {
      switch (activeTab) {
        ...
        case 'currencies':
            return <div className="p-8 text-center text-slate-500">Currencies setup functionality is under development.</div>;
        case 'rights':
