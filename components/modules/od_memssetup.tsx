...
const OdMemsSetupPage: React.FC<ModuleSetupPageProps> = ({ module, onBackToModules }) => {
        ...
        return (
          <div>
            ...
            <p className="text-gray-600">
              This is the dedicated setup page for the Organisational Design (OD) module.
              Here, administrators will configure the foundational settings required for this module to function, such as department types, management levels, and custom employee fields.
            </p>
          </div>
        );
      case 'rights':
...
export default OdMemsSetupPage;
