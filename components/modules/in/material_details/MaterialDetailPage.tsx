...
import { ConfigurationProgress } from './Shared';
import MaterialDashboardTab from './MaterialDashboardTab';
import MaterialAnalyticsTab from './MaterialAnalyticsTab';
import MasterDataInfoTab from './MasterDataInfoTab';
import WarehousedTab from './WarehousedTab';
import BinningTab from './BinningTab';
import InventoryDataTab from './InventoryDataTab';
import ProcurementDataTab from './ProcurementDataTab';
import MaterialClassificationTab from './MaterialClassificationTab';
