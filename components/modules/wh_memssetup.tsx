...
const WhMemsSetupPage: React.FC<ModuleSetupPageProps> = ({ module, onBackToModules }) => {
        ...
        return (
          <div>
            ...
            <p className="text-gray-600">
              This is the dedicated setup page for the Warehousing (WH) module.
              Here, administrators will configure the foundational settings required for this module to function, such as warehouse zones, bin types, and picking strategies (e.g., FEFO, LIFO).
            </p>
          </div>
        );
      case 'rights':
...
export default WhMemsSetupPage;
