...
const OdAdminPage: React.FC<ModuleAdminPageProps> = ({ module, onSwitchToUser, onBackToDashboard, theme }) => {
  return (
    <div className="p-4 md:p-8 w-full">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600">
          This is the dedicated admin page for the Organisational Design (OD) module.
          Configuration options for departments, job titles, and reporting lines will be managed here.
        </p>
      </div>
    </div>
  );
