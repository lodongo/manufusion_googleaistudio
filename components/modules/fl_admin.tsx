...
const FlAdminPage: React.FC<ModuleAdminPageProps> = ({ module, onSwitchToUser, onBackToDashboard, theme }) => {
  return (
    <div className="p-4 md:p-8 w-full">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600">
          This is the dedicated admin page for the Fleet (FL) module.
          Configuration options for vehicle types, fuel cards, and telematics integration will be managed here.
        </p>
      </div>
    </div>
  );
