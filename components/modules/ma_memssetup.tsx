...
const MaMemsSetupPage: React.FC<ModuleSetupPageProps> = ({ module, onBackToModules }) => {
        ...
        return (
          <div>
            ...
            <p className="text-gray-600">
              This is the dedicated setup page for the Manufacturing (MA) module.
              Here, administrators will configure the foundational settings required for this module to function, such as work center definitions, bills of materials (BOM), and production routing.
            </p>
          </div>
        );
      case 'rights':
...
export default MaMemsSetupPage;
