...
const FlMemsSetupPage: React.FC<ModuleSetupPageProps> = ({ module, onBackToModules }) => {
        ...
        return (
          <div>
            ...
            <p className="text-gray-600">
              This is the dedicated setup page for the Fleet (FL) module.
              Here, administrators will configure the foundational settings required for this module to function, such as vehicle types, fuel measurement units (e.g., gallons, liters), and maintenance schedules.
            </p>
          </div>
        );
      case 'rights':
...
export default FlMemsSetupPage;
