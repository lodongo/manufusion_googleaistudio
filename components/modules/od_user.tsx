...
const OdUserPage: React.FC<ModulePageProps> = ({ module, currentUser, onSwitchToAdmin, onBackToDashboard, theme }) => {
    ...
    <div className="p-4 md:p-8 w-full">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600">
          This is the dedicated user page for the Organisational Design (OD) module.
          Future functionality like viewing the org chart and employee directory will be displayed here.
        </p>
      </div>
    </div>
  );
