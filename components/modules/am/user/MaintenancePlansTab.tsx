...
import PlannedCorrectiveMaintenanceSubTab from './maintenance_plans/PlannedCorrectiveMaintenanceSubTab';
import PlannedOverhaulsSubTab from './maintenance_plans/PlannedOverhaulsSubTab';
        ...
        <div className="bg-white rounded-b-lg shadow-md">
            ...
            <div className="p-6">
                {subTab === 'planned_corrective' && (
                    <PlannedCorrectiveMaintenanceSubTab
                        currentUser={currentUser}
                        theme={theme}
                        organisation={organisation}
