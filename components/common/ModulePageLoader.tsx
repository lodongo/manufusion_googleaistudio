...
const components = {
    ...
    // EM Module (Energy Management)
    em_user: React.lazy(() => import('../modules/em_user')),
    em_admin: React.lazy(() => import('../modules/em_admin')),
    em_memssetup: React.lazy(() => import('../modules/em_memssetup')),
};
